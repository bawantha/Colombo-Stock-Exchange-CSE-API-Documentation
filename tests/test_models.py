...
from cse_lk.models import (
    CompanyInfo, CompanyLogo, TradeSummary, SharePrice, TopGainer, TopLoser,
    ActiveTrade, MarketStatus, MarketSummary, IndexData, Sector,
    DetailedTrade, DailyMarketSummary, Announcement
)
...
class TestCompanyInfo:
    ...
    def test_from_dict_complete(self):
        ...
        data = {
            ...
            "reqLogo": {
                "id": 456,
                "path": "upload_logo/test_company.png"
            },
            "reqSymbolBetaInfo": {
                "betaValueSPSL": 1.25
            }
