...
class TestCSEClient:
    ...
    def test_get_company_info(self, mock_request):
        ...
        assert result.logo.full_url == "https://cdn.cse.lk/cmt/upload_logo/378_1601611239.jpeg"
        
        mock_request.assert_called_once_with("companyInfoSummery", {"symbol": "LOLC.N0000"})
    ...
    def test_get_market_overview(self, mock_active, mock_losers, mock_gainers,
                               mock_snp, mock_aspi, mock_summary, mock_status):
